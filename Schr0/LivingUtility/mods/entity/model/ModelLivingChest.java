...
public class ModelLivingChest extends ModelBase {
	public interface MotionFactory {
		LivingChestMotion<ModelLivingChest> create(EntityLivingChest chast, LivingChestMotionData targetMotionData, LivingChestMotionMap<ModelLivingChest> map);
	}
	...
	public ModelLivingChest() {
		...
		Core.mirror = true;
		/*
		 * Body.setRotationPoint( 0F, 9F, 0F ); Core.setRotationPoint( 0F, 11F,
		 * -7F );
		 */
		Core.setRotationPoint(0F, 2F, -7F);
		/*
		 * setRotation(Body, 0F, 0F, 0F); setRotation(Core, 0F, 0F,
		 * -0.7853982F);
		 */
		...
		Cover.mirror = true;
		/*
		 * Body.setRotationPoint(0F, 9F, 0F); Cover.setRotationPoint(0F, 5F,
		 * 7F);
		 */
		Cover.setRotationPoint(0F, -4F, 7F);
		/*
		 * setRotation( Body, 0F, 0F, 0F ); setRotation( Cover, 0F, 0F, 0F );
		 */
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
		...
		// LivingChestMotion<ModelLivingChest> mo = motionData.getMotion(this,
		// motionData.getCurrentCoverMotion());
		//
	...
	public void setupMotionMappingToMotionData(EntityLivingChest chast, LivingChestMotionData targetMotionData) {
		...
		Set<? extends LivingChestMotion<ModelLivingChest>> motions = Sets.newHashSet(none, none.getMotionClose(), none.getMotionOpen(),
				none.getMotionMomentaryOpen());

		LivingChestMotionMap<ModelLivingChest> map = new LivingChestMotionMap<ModelLivingChest>(this.getClass(), motions);
